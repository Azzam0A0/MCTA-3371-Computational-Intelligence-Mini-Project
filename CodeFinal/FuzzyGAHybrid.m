...
function population = initialize_population(pop_size, path_length, ~)
...
function metrics = calculate_performance_metrics(path, map_grid, ~, goal_pos, generations)
...
function display_ga_results(map_grid, best_path, ~, goal_pos, map_name, ~, ~, metrics)
